...
import com.momo.nettyrpc.client.RpcClientHandler;
import com.momo.nettyrpc.client.RpcClientInitializer;
    ...
    private void connectServerNode(final InetSocketAddress remotePeer) {
        threadPoolExecutor.submit(new Runnable() {
            ...
            public void run() {
                ...
                //装配bootstrap
                b.group(eventLoopGroup)//多线程处理
                        .channel(NioSocketChannel.class)//指定通道类型为NioSocketChannel
                        .handler(new RpcClientInitializer());//业务处理类
